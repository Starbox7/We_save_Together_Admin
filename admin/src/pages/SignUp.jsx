    ...
    return (
        <Container>
            <Form onSubmit={handleSubmit}>
                ...
                <Input id="verificationCode" name="verificationCode" type="text" value={formData.verificationCode} onChange={handleChange} />

                <Button type="button" onClick={verifyCode} disabled={!formData.verificationCode}>
                    인증번호 확인
                </Button>

                <Button type="submit" disabled={Object.keys(errors).length > 0 || !formData.verificationCode}>
                    회원가입
                </Button>
            </Form>
        </Container>
